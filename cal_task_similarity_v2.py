...
# For task vector 1
#set this flag to 1 when working with linearFT setting
flag1 = 0
tasks1 = [
    ...
    {
        "task": "sst5",
        "pretrained": "checkpoints/gpt2_standard_classification_sst5/zeroshot_full_model.pt",
        "finetuned": "checkpoints/gpt2_standard_classification_sst5/epoch_checkpoint_full_model_0_1067.pt",
        "labels": "5",
    }
]
...
tasks2 = [
    ...
    {
        "task": "sst2",
        "pretrained": "checkpoints/gpt2_standard_classification_sst2/zeroshot_full_model.pt",
        "finetuned": "checkpoints/gpt2_standard_classification_sst2/epoch_checkpoint_full_model_0_8418.pt",
        "labels": "2",
    }
]
